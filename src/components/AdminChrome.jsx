    ...
    return (
      <div className="cms-overlay">
        <div className="cms-card">
          ...
          <p>Please wait while we verify your website editor access.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="cms-overlay">
      ...
      >
        ...
        <p>
          Enter the email address approved to edit the site. You'll get a secure sign-in link.
        </p>
  ...
  return (
    <div className="cms-overlay">
      <div className="cms-card">
        ...
        <p>
          This email has signed in, but it hasn't been approved as a website
          editor yet. Ask the website owner to approve your account.
        </p>
  ...
  return (
    <div className="cms-toolbar">
      ...
      <div className="cms-toolbar-modes">
        ...
        <button
          type="button"
          className={mode === 'style' ? 'is-active' : ''}
...
function StylePanel() {
  ...
  const current =
    getByPath(content, `styles.${stylePanelPath}`) || {}
  ...
  return (
    <div className="cms-style-panel">
      ...
      <button
        ...
        onClick={() => clearStyle(stylePanelPath)}
      >
