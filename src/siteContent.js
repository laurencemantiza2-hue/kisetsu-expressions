...
export const defaultSiteContent = {
  ...
  intro: {
    ...
    paragraph: 'At Kisetsu Expressions, we believe what you wear can say something about who you are. Our T-shirts are created to bring personality, creativity, and meaning into everyday style.',
  },
  paintingsSection: {
    eyebrow: 'ORIGINAL PAINTINGS',
    heading: 'Art that gives\na room a story.',
    description: 'Discover original paintings created to bring warmth, colour, and a personal sense of expression into your space.',
    buttonLabel: 'Explore Paintings →',
  },
  studentArtSection: {
    eyebrow: 'STUDENT ART',
    heading: 'Big imagination.\nProudly shared.',
    description: 'Student art is where confidence grows and new voices emerge. Explore the creativity, care, and individuality behind each piece.',
    buttonLabel: 'Explore Student Art →',
  },
  workshopsSection: {
    eyebrow: 'CREATIVE WORKSHOPS',
    heading: 'Make something\nmeaningful together.',
    description: 'Plan a relaxed, guided art experience for your group. Tell us your preferred date, group size, and creative idea, and we will help shape the session.',
  },
  about: {
    heading: 'Made to\nexpress.',
    paragraph1: 'Kisetsu Expressions is a creative T-shirt brand focused on meaningful designs and expressive everyday wear.',
    paragraph2: 'Each design is created with the idea that clothing can be more than something you wear. It can represent an idea, a feeling, a memory, or simply your personality.',
    paragraph3: 'This is just the beginning. As Kisetsu grows, more products and creative expressions will be introduced.',
  },
  tshirtsSection: {
  ...
  cta: {
    ...
    heading: 'Find your\nexpression.',
    description: "See something you like? Contact Kisetsu Expressions directly and let's get your T-shirt ready.",
  },
  contact: {
    heading: "Let's talk\nT-shirts.",
  },
...
function deepMerge(base, saved) {
  if (!isPlainObject(base)) return saved !== undefined ? saved : base
  const result = { ...base }
  if (isPlainObject(saved)) {
    ...
    for (const key of Object.keys(saved)) {
      if (!(key in base)) result[key] = saved[key]
    }
  }
  return result
}
